...
var _media = require("./runtime/media");
let id = 0;
const instances = [];
class Artplayer extends (0, _emitterDefault.default) {
    ...
    static get normalizeMedia() {
        return 0, _media.normalizeMedia;
    }
    static get option() {
        return {
            id: '',
...
var _mediaMix = require("./mediaMix");
var _mediaMixDefault = parcelHelpers.interopDefault(_mediaMix);
var _actionMix = require("./actionMix");
var _actionMixDefault = parcelHelpers.interopDefault(_actionMix);
var _indexJs = require("./playlist/index.js");
...
class Player {
    constructor(art){
        ...
        (0, _mediaMixDefault.default)(art);
        (0, _actionMixDefault.default)(art);
        (0, _indexJsDefault.default)(art);
...
function urlMix(art) {
    ...
    (0, _propertyJs.def)(art, 'url', {
        ...
        async set (newUrl) {
            if (newUrl) {
                ...
                const typeCallback = option.customType[typeName] || (0, _indexJs.getAdapter)(typeName);
                (0, _indexJs.destroyAdapter)(art);
                if (typeName && typeCallback) {
                    await (0, _timeJs.sleep)();
    ...
    art.once('destroy', ()=>(0, _indexJs.destroyAdapter)(art));
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"5dUr6","../utils/file.js":"luB4T","../utils/property.js":"91nLd","../utils/time.js":"f9kBR","./adapters/index.js":"bylVq"}],"bylVq":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getAdapter", ()=>getAdapter);
parcelHelpers.export(exports, "destroyAdapter", ()=>destroyAdapter);
var _hlsJs = require("./hls.js");
var _hlsJsDefault = parcelHelpers.interopDefault(_hlsJs);
var _dashJs = require("./dash.js");
var _dashJsDefault = parcelHelpers.interopDefault(_dashJs);
const adapters = {
    m3u8: (0, _hlsJsDefault.default),
    hls: (0, _hlsJsDefault.default),
    mpd: (0, _dashJsDefault.default),
    dash: (0, _dashJsDefault.default)
};
function getAdapter(type) {
    return adapters[type];
}
function destroyAdapter(art) {
    if (art.hls) {
        art.hls.destroy?.();
        delete art.hls;
    }
...
},{"./hls.js":"dOjI0","./dash.js":"jBlSq","@parcel/transformer-js/src/esmodule-helpers.js":"5dUr6"}],"dOjI0":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>hlsAdapter);
function getHls() {
...
function hlsAdapter(video, url, art) {
    const Hls = getHls();
    if (Hls?.isSupported?.()) {
        const hls = new Hls({
            enableWorker: true,
    ...
    else unsupported(art, 'm3u8');
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"5dUr6"}],"jBlSq":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>dashAdapter);
function getDash() {
    const scope = typeof window !== 'undefined' ? window : globalThis;
    return scope.dashjs;
}
...
function dashAdapter(video, url, art) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5dUr6"}],"jDj6f":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function screenshotMix(art) {
    ...
    (0, _propertyJs.def)(art, 'getDataURL', {
    ...
    (0, _propertyJs.def)(art, 'getBlobUrl', {
        value: ()=>new Promise((resolve, reject)=>{
                try {
                    drawVideo();
                    $canvas.toBlob((blob)=>{
    ...
    (0, _propertyJs.def)(art, 'getScreenshotBlob', {
        value: (format = 'png', quality = 0.92)=>new Promise((resolve, reject)=>{
                try {
                    drawVideo();
    ...
    (0, _propertyJs.def)(art, 'screenshot', {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5dUr6","../utils/property.js":"91nLd"}],"gNUzM":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function qualityMix(art) {
    ...
    (0, _propertyJs.def)(art, 'qualities', {
        get () {
            return qualities;
        }
    });
    (0, _propertyJs.def)(art, 'updateQuality', {
        value: updateQuality
    });
    (0, _propertyJs.def)(art, 'quality', {
        get () {
            return qualities;
        },
        set (quality) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5dUr6","../utils/property.js":"91nLd"}],"fuLsO":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../utils":"jmgNb","@parcel/transformer-js/src/esmodule-helpers.js":"5dUr6"}],"98Oqc":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>mediaMix);
var _propertyJs = require("../utils/property.js");
var _mediaJs = require("../runtime/media.js");
function isObjectUrlSource(value) {
    return value && typeof value === 'object' && typeof URL !== 'undefined' && typeof URL.createObjectURL === 'function' && (typeof Blob !== 'undefined' && value instanceof Blob || typeof File !== 'undefined' && value instanceof File);
}
function applyStartTime(art, media) {
    ...
    if ((art.video?.readyState || 0) >= 1) seek();
    else if (typeof art.once === 'function') art.once('video:loadedmetadata', seek);
}
...
function applyDanmakuPlugin(art, option) {
    ...
    const config = Array.isArray(option) ? {
        danmuku: list
    } : {
        ...option,
        danmuku: list
    ...
    plugin.reset?.();
    plugin.load?.(list);
    if (config.visible === false) plugin.hide?.();
    else plugin.show?.();
}
function mediaMix(art) {
    let currentMedia = null;
    let subtitleTracks = [];
    let danmaku = [];
    let audioTracks = [];
    (0, _propertyJs.def)(art, 'currentMedia', {
        get () {
            return currentMedia;
        }
    });
    (0, _propertyJs.def)(art, 'getCurrentMedia', {
        value () {
            return currentMedia;
        }
    });
    (0, _propertyJs.def)(art, 'subtitleTracks', {
        get () {
            return subtitleTracks;
        }
    });
    (0, _propertyJs.def)(art, 'setSubtitles', {
        async value (tracks = []) {
            subtitleTracks = toArray(tracks);
            const track = pickDefault(subtitleTracks);
            if (!track?.url) {
                if (typeof art.subtitle?.clear === 'function') art.subtitle.clear();
                else if (art.subtitle) art.subtitle.url = '';
                if (art.subtitle) art.subtitle.show = false;
                try {
                    art.setting.remove('subtitle');
                } catch  {}
                if (typeof art.emit === 'function') art.emit('subtitle:change', null, subtitleTracks);
                return null;
            }
            await art.subtitle.switch(track.url, track);
            art.subtitle.show = true;
            if (typeof art.emit === 'function') art.emit('subtitle:change', track, subtitleTracks);
            return track;
        }
    });
    (0, _propertyJs.def)(art, 'selectSubtitle', {
        async value (track, tracks = subtitleTracks) {
            if (!track?.url) return art.setSubtitles([]);
            const list = [
                track,
                ...toArray(tracks).filter((item)=>item?.url && item.url !== track.url)
            ];
            return art.setSubtitles(list.map((item, index)=>({
                    ...item,
                    default: index === 0
                })));
        }
    });
    (0, _propertyJs.def)(art, 'danmaku', {
        get () {
            return danmaku;
        }
    });
    (0, _propertyJs.def)(art, 'setDanmaku', {
        value (option = []) {
            danmaku = option || [];
            applyDanmakuPlugin(art, danmaku);
            if (typeof art.emit === 'function') art.emit('danmaku:change', danmaku);
            return danmaku;
        }
    });
    (0, _propertyJs.def)(art, 'audioTracks', {
        get () {
            return audioTracks;
        }
    });
    (0, _propertyJs.def)(art, 'setAudioTracks', {
        value (tracks = []) {
            audioTracks = toArray(tracks);
            if (typeof art.emit === 'function') art.emit('audioTracks:change', audioTracks);
            return audioTracks;
        }
    });
    (0, _propertyJs.def)(art, 'playMedia', {
        async value (input) {
            const media = (0, _mediaJs.normalizeMedia)(input);
            currentMedia = media;
            ...
            if (typeof art.emit === 'function') art.emit('media:change', media);
            art.url = toPlayableUrl(media.url);
            applyStartTime(art, media);
            if (typeof media.qualityLoader === 'function' && typeof art.updateQuality === 'function') Promise.resolve(media.qualityLoader()).then((qualities)=>{
                if (currentMedia === media) art.updateQuality(qualities || []);
            }).catch((err)=>{
                if (typeof art.emit === 'function') art.emit('quality:error', err, media);
            });
            if (typeof art.play === 'function') await art.play();
            return media;
        }
    });
}

},{"../utils/property.js":"91nLd","../runtime/media.js":"7D18g","@parcel/transformer-js/src/esmodule-helpers.js":"5dUr6"}],"7D18g":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "normalizeMedia", ()=>normalizeMedia);
...
function normalizeMedia(input = {}) {
    const media = typeof input === 'string' ? {
        url: input
    } : {
        ...input
    };
    const sources = normalizeList(media.sources, (source)=>normalizeSource(source, media));
    const qualities = normalizeList(media.qualities || media.quality, (quality)=>isObject(quality) ? {
            ...quality
        } : null);
    if (!sources.length && media.url) sources.push({
        url: media.url,
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5dUr6"}],"9Us4p":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../config":"2ZnKD","../utils":"jmgNb","@parcel/transformer-js/src/esmodule-helpers.js":"5dUr6"}],"fQFSv":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>actionMix);
var _propertyJs = require("../utils/property.js");
...
function actionMix(art) {
    let loopSegment = null;
    let pendingLoopStart = null;
    (0, _propertyJs.def)(art, 'loopSegment', {
        get () {
            return loopSegment;
        }
    });
    (0, _propertyJs.def)(art, 'emitAction', {
        value (type, detail = {}) {
    ...
    (0, _propertyJs.def)(art, 'setLoopSegment', {
        value (start, end) {
    ...
    (0, _propertyJs.def)(art, 'clearLoopSegment', {
        value () {
            loopSegment = null;
            pendingLoopStart = null;
    ...
    (0, _propertyJs.def)(art, 'captureTimestamp', {
        value (detail = {}) {
            return art.emitAction('timestamp', detail);
        }
    });
    (0, _propertyJs.def)(art, 'captureLoopSegment', {
        value () {
...
},{"../utils/property.js":"91nLd","@parcel/transformer-js/src/esmodule-helpers.js":"5dUr6"}],"fm63e":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>playlistMix);
var _propertyJs = require("../../utils/property.js");
...
function findAnyItem(playlist, id) {
    return findItem(playlist, id) || playlist.favorites.find((item)=>item.id === id || item.url === id) || playlist.history.find((item)=>item.id === id || item.url === id) || null;
}
...
function playlistMix(art) {
    let playlist = (0, _schemaJs.normalizePlaylist)();
    let playlistIndex = -1;
    let page = 'playlist';
    function render() {
        if (art.template?.$playlist) (0, _viewJs.renderPlaylist)(art, page);
    }
    ...
    async function playItem(item) {
        ...
        if (typeof playlist.onPlayItem === 'function') await playlist.onPlayItem(item, playlistIndex, playlist);
        else if (typeof art.playMedia === 'function') await art.playMedia(item);
        render();
        return item;
    }
    (0, _propertyJs.def)(art, 'playlist', {
        get () {
            return playlist;
        }
    });
    (0, _propertyJs.def)(art, 'playlistIndex', {
        get () {
            return playlistIndex;
        }
    });
    (0, _propertyJs.def)(art, 'currentPlaylistItem', {
        get () {
            return playlist.items[playlistIndex] || null;
        }
    });
    (0, _propertyJs.def)(art, 'setPlaylist', {
        value (input, current) {
            playlist = (0, _schemaJs.normalizePlaylist)(input);
    ...
    (0, _propertyJs.def)(art, 'renderPlaylist', {
        value (nextPage = page) {
            page = nextPage;
            render();
        }
    });
    (0, _propertyJs.def)(art, 'playlistShow', {
        get () {
    ...
    (0, _propertyJs.def)(art, 'playlistToggle', {
        value () {
            art.playlistShow = !art.playlistShow;
            return art.playlistShow;
        }
    });
    (0, _propertyJs.def)(art, 'playlistPlay', {
        value (id) {
            return playItem(findItem(playlist, id) || playlist.items[playlistIndex] || null);
        }
    });
    (0, _propertyJs.def)(art, 'playlistNext', {
        value () {
            return playItem(setCurrent(playlistIndex + 1));
        }
    });
    (0, _propertyJs.def)(art, 'playlistPrev', {
        value () {
            return playItem(setCurrent(playlistIndex - 1));
        }
    });
    (0, _propertyJs.def)(art, 'playlistAdd', {
        value (item, groupId) {
            const next = (0, _schemaJs.normalizePlaylist)({
                items: [
                    item
                ]
            }).items[0];
    ...
    (0, _propertyJs.def)(art, 'playlistRemove', {
        value (id) {
    ...
    (0, _propertyJs.def)(art, 'togglePlaylistFavorite', {
        async value (id) {
            const item = findAnyItem(playlist, id);
            ...
            if (typeof playlist.onToggleFavorite === 'function') await playlist.onToggleFavorite(item, favorite, playlist);
            art.emit('playlist:favorite', item, favorite);
            render();
            return favorite;
        }
    });
    (0, _propertyJs.def)(art, 'clearPlaylistHistory', {
        async value () {
            playlist.history = [];
            if (typeof playlist.onClearHistory === 'function') await playlist.onClearHistory(playlist);
            art.emit('playlist:history:clear', playlist);
            render();
            return playlist.history;
        }
    });
    if (art.template?.$playlist && art.events?.proxy) art.events.proxy(art.template.$playlist, 'click', async (event)=>{
...
},{"../../utils/property.js":"91nLd","./schema.js":"b3zMd","./view.js":"iBVGu","@parcel/transformer-js/src/esmodule-helpers.js":"5dUr6"}],"b3zMd":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "normalizePlaylist", ()=>normalizePlaylist);
function isObject(value) {
    return value && typeof value === 'object' && !Array.isArray(value);
}
...
function collectNodeItems(nodes, output = []) {
    nodes.forEach((node)=>{
        if (node.item?.url || node.url) output.push(node.item || normalizeItem(node, output.length, 'tree'));
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5dUr6"}],"iBVGu":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderPlaylist", ()=>renderPlaylist);
...
function renderItem(item, current) {
    ...
    return `
        <div class="art-playlist-item${active ? ' is-active' : ''}${favorite}" data-id="${escapeText(item.id || item.url)}">
            ...
            <button class="art-playlist-favorite" data-action="favorite" title="Favorite">\u{2605}</button>
            <button class="art-playlist-remove" data-action="remove" title="Remove">\xd7</button>
        </div>
    `;
}
...
function renderPlaylist(art, page = 'playlist') {
    ...
    const markFavorite = (item)=>({
            ...item,
            _favorite: favorites.has(item.id || item.url)
        });
    const markedGroups = playlist.groups.map((group)=>({
            ...group,
            items: group.items.map(markFavorite)
        }));
    const markedRoots = playlist.roots.map((node)=>node);
    const markedFavorites = playlist.favorites.map((item)=>({
            ...item,
            _favorite: true
        }));
    const markedHistory = playlist.history.map(markFavorite);
    const body = page === 'favorites' ? renderCollection('Favorites', markedFavorites, currentPlaylistItem) : page === 'history' ? renderCollection('History', markedHistory, currentPlaylistItem, true) : `${markedGroups.map((group)=>renderGroup(group, currentPlaylistItem)).join('')}
    ...
    template.$playlist.innerHTML = `
        <div class="art-playlist-panel">
            <div class="art-playlist-header">
                ...
                <button data-action="close">\xd7</button>
            </div>
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5dUr6"}],"faO0X":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _actionDefault = parcelHelpers.interopDefault(_action);
var _playlist = require("./playlist");
var _playlistDefault = parcelHelpers.interopDefault(_playlist);
...
class Control extends (0, _componentDefault.default) {
    ...
    init() {
        ...
        const actions = option.actions === true ? [
            'timestamp',
            'loopSegment',
            'mediaNotes'
        ] : option.actions;
        ...
        if (Array.isArray(actions) && !(0, _utils.isMobile)) actions.forEach((name)=>{
            if (!actionOptions[name]) return;
            this.add((0, _actionDefault.default)({
                name,
        ...
        if (option.playlist && !(0, _utils.isMobile)) this.add((0, _playlistDefault.default)({
            name: 'playlist',
            position: 'right',
            index: 25
        }));
...
},{"../utils/component":"bgug2","./fullscreen":"bHDMy","./fullscreenWeb":"8HUSd","./pip":"5nd2H","./playAndPause":"gt2F0","./progress":"aHyb0","./time":"hL9ry","./volume":"3G9Wa","./setting":"jQ9Bw","./screenshot":"aA6wc","./airplay":"iKTFA","../utils":"jmgNb","@parcel/transformer-js/src/esmodule-helpers.js":"5dUr6","./action":"jo9dI","./playlist":"3EI2q"}],"bgug2":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _dom = require("./dom");
var _error = require("./error");
...
},{"../utils":"jmgNb","@parcel/transformer-js/src/esmodule-helpers.js":"5dUr6"}],"jo9dI":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>action);
var _utils = require("../utils");
const icons = {
    timestamp: '<svg viewBox="0 0 24 24" style="fill:none;stroke:var(--art-font-color);stroke-width:2;stroke-linecap:round;stroke-linejoin:round"><circle cx="12" cy="12" r="9"></circle><path d="M12 7v5l3 2"></path><path d="M16 19h6"></path><path d="M19 16v6"></path></svg>',
    loopSegment: '<svg viewBox="0 0 24 24" style="fill:none;stroke:var(--art-font-color);stroke-width:2;stroke-linecap:round;stroke-linejoin:round"><path d="m17 2 4 4-4 4"></path><path d="M3 11v-1a4 4 0 0 1 4-4h14"></path><path d="m7 22-4-4 4-4"></path><path d="M21 13v1a4 4 0 0 1-4 4H3"></path></svg>',
    mediaNotes: '<svg viewBox="0 0 24 24" style="fill:none;stroke:var(--art-font-color);stroke-width:2;stroke-linecap:round;stroke-linejoin:round"><path d="M8 2v4"></path><path d="M16 2v4"></path><rect x="4" y="4" width="16" height="18" rx="2"></rect><path d="M8 10h8"></path><path d="M8 14h5"></path><path d="m15 19 4-4 2 2-4 4h-2z"></path></svg>'
};
function action(option) {
    return (art)=>({
            ...
            mounted: ($control)=>{
                (0, _utils.append)($control, icons[option.name]);
            },
            click: ()=>{
                switch(option.name){
                    case 'timestamp':
...
},{"../utils":"jmgNb","@parcel/transformer-js/src/esmodule-helpers.js":"5dUr6"}],"3EI2q":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>playlist);
var _utils = require("../utils");
const icon = '<svg viewBox="0 0 24 24" style="fill:none;stroke:var(--art-font-color);stroke-width:2;stroke-linecap:round;stroke-linejoin:round"><path d="M8 6h13"></path><path d="M8 12h13"></path><path d="M8 18h13"></path><path d="M3 6h.01"></path><path d="M3 12h.01"></path><path d="M3 18h.01"></path></svg>';
function playlist(option) {
    return (art)=>({
            ...option,
            tooltip: art.i18n.get('Playlist'),
            mounted: ($control)=>{
                (0, _utils.append)($control, icon);
            },
            click: ()=>{
                art.playlistToggle();
            }
